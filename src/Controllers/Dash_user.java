...
public class Dash_user implements Initializable {
    ...
    @FXML
    HBox btDash, btServicos, btClientes;
    ...
    public void setFuncs(){
        ...
        btAddFun.setVisible(false);

        System.out.println("Verficando permisoes !");

        if(user.getVerfRelatorio() != 1){
            btDash.setDisable(true);

            dashPane.setVisible(false);


            if(user.getVerfOrc() != 1){
                btServicos.setDisable(true);

                if(user.getVerfCli() != 1){
